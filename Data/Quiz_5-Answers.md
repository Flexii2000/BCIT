...
Answer: True, squared values react stronger on outliers.
...
Answer: False, a high accuracy can also indicate overfitting of the model.
...
Answer: "The model becomes too sensitive to noise and overfits the data."
...
Answer: False, standard deviation measures variance and distribution, not central tendency.
...
Answer: True, this could lead to an error missing true positive cases
...
Answer: "Can detect hidden patterns in unlabeled data". Supervised learning requires labeled data.
...
Answer: "It reduces overfitting by averaging multiple decision trees trained on different subsets of the data."
...
Answer: "k-Nearest Neighbors (k-NN)". Lazy learner that does not create explicit boundaries.
...
Answer: "A perfect classifier will have an ROC curve that passes through the top-left corner (1,1)."
...
Answer: "F1-Score". F1 balances precision.
...
Answer: False. The described metric is Recall, not Precision.
...
Answer: "Logistic regression predicts probabilities using a sigmoid function, whereas linear regression predicts continuous values."
...
Answer: "Increasing the sample size generally leads to a narrower confidence interval."
...
Answer: "Confidence Interval Estimation"
...
Answer: True. kNN is a lazy learner, meaning it is getting expensive during analysis.
...
Answer: "The test data contains patterns the model has never seen before". Bad test/train split can lead to failure.
...
Answer: "The dependent variable must be categorical"
...
Answer: "A linear SVM always performs better than a k-NN classifier."
...
Answer: "It is computationally expensive for large datasets."